            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <thead class="bg-gray-100 dark:bg-indigo-200">
                                <tr>
                                    <th
                                        scope="col"
                                        class="px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                                    >
                                        <button
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td
                                        class="py-4 text-sm font-medium whitespace-nowrap"
                                    >
                                        <div
                                            :class="
                                                event.status == 'open'
...
var prevPage = () => {
    if (offset > 0) {
        offset.value = offset.value - itemsPerPage;
    } else {
        offset.value = 0;
    }
};
var nextPage = () => {
    const nextPage = offset.value + itemsPerPage;
    const limit = props.events.length - 1;

    if (nextPage < limit) {
        offset.value = nextPage;
    } else {
        offset.value = limit - itemsPerPage;
    }
};
</script>
